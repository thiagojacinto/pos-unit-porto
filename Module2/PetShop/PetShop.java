	...
	public static void main(String[] args) {
		...
		while (wannnaAddNewAnimal) {
			...
			if (operation == 0) {	// Operation to INSERT animal to the System;
				...
				System.out.println("What type of animal? Choose: \n '1' for a Dog; \n '2' for a Cat; \n '3' for a Bird.");
				...
				if (animalNumber == 1) {
					...
					// Setting age:
					System.out.println("How old is " + dog2.nameString + ": ");
					dog2.age = scan.nextInt();

					// Setting gender:
					System.out.println("And the gender of " + dog2.nameString + ": ");
					dog2.genderString = scan.next();

					// Setting age:
					System.out.println("Finally, how much weights our " + dog2.nameString + "? ");
					...
					// Setting age:
					System.out.println("How old is " + cat2.nameString + ": ");
					cat2.age = scan.nextInt();

					// Setting gender:
					System.out.println("And the gender of " + cat2.nameString + ": ");
					cat2.genderString = scan.next();

					// Setting age:
					System.out.println("Finally, how much weights our " + cat2.nameString + "? ");
					...
					// Setting age:
					System.out.println("How old is " + bird2.nameString + ": ");
					bird2.age = scan.nextInt();

					// Setting gender:
					System.out.println("And the gender of " + bird2.nameString + ": ");
					bird2.genderString = scan.next();

					// Setting age:
					System.out.println("Finally, how much weights our " + bird2.nameString + "? ");
